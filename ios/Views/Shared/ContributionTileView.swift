//
//  ContributionTileView.swift
//  VoteVault
//

import SwiftUI

// MARK: - Contribution Tile View
struct ContributionTileView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            InfoRow(label: "Occupation", value: contribution.contributor_occupation ?? "N/A")
