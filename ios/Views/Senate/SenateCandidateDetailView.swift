//
// File: SenateCandidateDetailView.swift (MODIFIED)
// Folder: Views/Senate
//

import SwiftUI

struct SenateCandidateDetailView: View {
    ...
    func fetchContributionData(from endpoint: String, group: DispatchGroup) {
        ...
        let urlString = "https://api.open.fec.gov/v1/schedules/schedule_a/\(endpoint)/?cycle=\(electionYear)&committee_id=\(candidate.candidate_pcc_id ?? "C00343871")&sort=\(sortKey)&per_page=10&api_key=\(apiKey)"
